...
- Playbooks: `video-production`, `ad-voice`, `adversarial-critique`, `importing-footage`, `speech-synced-ui`, `motion-design`, `shader-backgrounds`, `segmentation`. Also: `npx skills add sdkv2/kino`.
