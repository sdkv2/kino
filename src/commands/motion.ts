...
export function motionHelpText(): string {
  return [
    ...
    "  · Comments are stripped before the lint scan — banned tokens in comments alone are OK.",
    "",
    ...
    "  skills/video-production § Make motion graphics move.",
    "",
    ...
    "  After real VO: still --around --real  or  frames <mp4> --around <t>",
    "",
