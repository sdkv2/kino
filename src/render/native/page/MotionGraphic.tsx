...
import { motionScrubStyle, KINO_DEFS } from "./motionCss";

// Shadow-root surface: the ease vars scope to :host. The raster surface (bgTextures) passes its own
// wrapper class instead — same stylesheet, see ./motionCss.
const KINO_SCRUB_STYLE = motionScrubStyle(":host");
