...
// ~1.9s/frame with CoreML vision backbone + every=2; MLX preferred when KINO_SAM_MLX_PYTHON
// set (~2.4s/frame mean here). PyTorch CPU fallback ~7–8s. Fixture is a TINY 8-frame 384px clip.
