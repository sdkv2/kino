...
describe("lintMotionHtml", () => {
  ...
  it("allows SVG SMIL inside .kino-lens-shape only", () => {
    const html = `<div class="kino-lens"><svg class="kino-lens-shape" viewBox="0 0 1 1"><path d="M0 0"><animate attributeName="d" dur="1s"/></path></svg></div>`;
    expect(lintMotionHtml(html)).toEqual([]);
