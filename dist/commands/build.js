...
const KICKER_FG = { mint: "#06210f", green: "#ffffff", gold: "#0b1020" };
export async function build(specPath, opts) {
    ...
    const formats = (opts.format ? opts.format.split(",") : spec.format);
    ...
    const props = {
        ...
        segments: spec.segments.map((seg, i) => ({
            ...
            kicker: seg.kind === "app" && seg.kicker
