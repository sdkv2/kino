...
keyframed `ks.o`/`ks.p`, etc.), not to be production-ready animations. For adapting real
LottieFiles templates into a project, see the sourcing/adaptation notes in
