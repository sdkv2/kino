...
| `shader-backgrounds` | WebGL `.frag` / `.glsl` custom backgrounds (ShaderToy `mainImage`, texture channels, `kino-lens` pairing) — raymarch / plasma stages, not Canvas2D wash or Blender. |
