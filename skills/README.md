...
| `segmentation` | `kino segment` masks + `regionShader` — cutting a subject out of its footage: per-region shader bodies, per-object materials, cutout compositing onto another clip, rim/erode via mask distance. |
